      ...
      nodes.forEach((node, i) => {
        ...
        nodes.forEach((otherNode, j) => {
          ...
          if (distance < 150) {
            ...
            const isRed = (i + j) % 2 === 0;
            if (isRed) {
              ctx.strokeStyle = `rgba(208, 0, 0, ${opacity * 0.4})`;
            } else {
        ...
        if (node.connections.length > 3) {
          gradient.addColorStop(0, "rgba(208, 0, 0, 0.8)");
          gradient.addColorStop(1, "rgba(208, 0, 0, 0)");
        ...
        // Draw core
        ctx.fillStyle = node.connections.length > 3 ? "#d00000" : "#ffffff";
        ctx.beginPath();
